...
subroutine carma_column_sulfate(rmrat, rmin, rhop, t_0, p_0, h2so4_0, h2o_0, mmr_0, dt, nt, constant_h2so4, nbin, nlayer, mmr_out, t_out, p_out, h2so4_out, h2o_out, rhoa_out, rh_out)
